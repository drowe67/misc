...
Compared to existing FreeDV 700D/700E algorithms:
\begin{enumerate}
\item New equalisation algorithm that performs well on a range of AWGN and multipath channels, removing the need for modes.
\item Diversity in frequency and possibly time providing around 3dB improvement on multipath channels.  
\item Dynamic threshold and pilot symbol selection for more robust acquisition. 
\end{enumerate}
