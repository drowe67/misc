...
Maintaining a viable digital voice link on multipath channels is challenging, as there are periods when the SNR of a packet is very low across all carriers. For HF data we can use long FEC codewords to ride over the fades but letancy concerns make this difficult for PTT speech.


TODO: spectrogram figure
TODO: simulate low rate code
...
\begin{figure}[h]
\caption{$n=2$ diversity simulation PER results. This metric better represents the effects of a non-uniform distribution of errors.  The benefits of larger delay are also clear.}
