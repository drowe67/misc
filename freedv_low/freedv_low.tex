...
\item Designing the probability of false sync states ``breaking squelch" on noise, removing the need for a squelch slider, and reducing listener fatigue.
\end{enumerate}
...
TODO: quite similar to above, include all loss terms to complete model (\ref{eq:snr_all}) above.  All loss term in glossary of symbols.
