...
TODO: ref and expression, brief discussion.

\section{Waveform Improvments}
...
\begin{enumerate}
\item Pilot symbols are used to estimate channel.  We require a 2 Hz bandwidth (fastest fading on MPP) and low noise (in AWGN channels) channel estimates.
...
TODO: also include frequency offset estimation and tracking.  Sensitivity of Doppler spread, freq offset errors with reduced $R_s$. 
...
\item Check performance of a few codes against 2dB figure above.  Include plots.
