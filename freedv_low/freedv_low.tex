...
\item Use of legacy analog HF radio sets with a RF bandwidth of 2000 Hz.
\end{enumerate}
...
SNR^\prime &= SNR + L_p  \quad [\si{dB}]Ideal 
\end{split}
\end{equation}
...
\item The $N_p=8$ pilot insertion rate means the pilot symbol loss $L_p=0.58 \si{dB}$ is low, giving good low SNR performance.
