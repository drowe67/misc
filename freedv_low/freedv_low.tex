...
SNR         &= 10log_{10} \left( \frac{E_sR^\prime_s}{N_0B} \right) - 10log_{10}(1-T_{cp}/T_s) \\
            &= 10log_{10} \left( \frac{E_sR^\prime_s}{N_0B} \right) + L_{cp} \quad [\si{dB}]
\end{split}
\end{equation}
