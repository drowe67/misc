...
\begin{equation}
y(dF_s) = G_1s(n)e^{j (\omega n + \phi_2)} + G_2e^{j \phi_1}
\end{equation}
...
\item Latest plot take aways. mean12 best on AWGN, but linls just 0.5dB worse.  We could try parallel demodulation.  linls 0.5dB on MPP and MPD, which is pretty good, lin 2dB, mean12 breaks on MPP.  Table useful here
