...
\begin{figure}[H]
\caption{$|Dt|$ as a function of frequency offset in multiples of $R_s$.  Our requirement is $\pm 200$ Hz or $\pm 4R_s$ (assuming $R_s \approx 50$ Hz) .  $P_c$ is a 13 point Barker sequence, chosen for it's correlation properties.}
\label{fig:acq_dt_q}
\begin{center}
\input acq_dt_q.tex
\end{center}
