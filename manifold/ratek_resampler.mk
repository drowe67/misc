...
PLOT_DATA := $(TRAIN)_k20_res1.txt $(TRAIN)_k20_res2.txt \
             $(TRAIN)_k80_res1.txt $(TRAIN)_k80_res2.txt 
...
$(TRAIN)_ratek.png: $(PLOT_DATA) FORCE
	echo "ratek_resampler_plot(\"$(TRAIN)_ratek.png\", \"$(TRAIN)_k20_res1.txt\",'r-*;k20 1;','continue',\"$(TRAIN)_k20_res2.txt\",'r-*;k20 2;', \
             \"$(TRAIN)_k80_res1.txt\",'c-+;k80 1;', \
             'continue', \"$(TRAIN)_k80_res2.txt\",'c--+;k80 2;' \
...
# (1) K=80 two stage VQ
$(TRAIN)_k80_res1.txt $(TRAIN)_k80_res2.txt: $(TRAIN)_y80.f32
	K=79 Kst=4 Ken=70 M=$(M) ./ratek_resampler.sh train_lbg $(TRAIN)_y80.f32 $(TRAIN)_k80
